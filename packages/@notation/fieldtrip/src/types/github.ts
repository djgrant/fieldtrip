...
export declare type EventContext = Pick<BaseContext<InstallationEvents> | BaseContext<RepoEvents>, "octokit" | "name" | "payload"> & {
    repo: <T>(o?: any) => {
        repo: string;
        owner: string;
    } & T;
};
declare type InstallationEvents = "installation.created" | "installation_repositories.added";
declare type RepoEvents = "issues.opened" | "issues.closed";
export declare class Github {
    context: EventContext;
    octokit: EventContext["octokit"];
    targetRepo: string;
    constructor(context: EventContext, options: {
        targetRepo: string;
    });
    ...
    get username(): string;
    get eventShouldBeIgnored(): boolean;
    repo<T extends Record<string, any>>(o?: T): T & {
        owner: string;
        repo: string;
    };
    private get fileProps();
    private maybeMarkdown;
    ...
    createBranch(branchName: string): Promise<import("@octokit/types").OctokitResponse<{
        ref: string;
        node_id: string;
        url: string;
        object: {

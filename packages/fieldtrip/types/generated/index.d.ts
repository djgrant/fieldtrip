...
interface DatabaseSchema {
    enrollments: {
        record: Enrollments;
        insert: Enrollments_InsertParameters;
    };
    events: {
        record: Events;
        insert: Events_InsertParameters;
    };
    executions: {
        record: Executions;
        insert: Executions_InsertParameters;
    };
    logs: {
        record: Logs;
        insert: Logs_InsertParameters;
    };
    migrations: {
        record: Migrations;
        insert: Migrations_InsertParameters;
    };
    task_stats: {
        record: TaskStats;
        insert: TaskStats_InsertParameters;
    };
    tasks: {
        record: Tasks;
        insert: Tasks_InsertParameters;
    };
}
...
export type { Enrollments, Enrollments_InsertParameters, Events, Events_InsertParameters, Tasks, Tasks_InsertParameters, Executions, Executions_InsertParameters, Logs, Logs_InsertParameters, Migrations, Migrations_InsertParameters, TaskStats, TaskStats_InsertParameters, };
